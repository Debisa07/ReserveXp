...
import AllAttributes from "./Seat Type/view/user-view"
export default function AdminDashbord() {
  ...
  <nav className="main-breadcrumb" aria-label="breadcrumb">
    <ol className="breadcrumb">
      ...
      <li className="breadcrumb-item ">
        <a href="/admin/module/flight">Seat Type</a>
      </li>
  ...
  <div className="container-fluid">
    <div className="d-flex justify-content-between mb20">
      <h1 className="title-bar">Seat Type: </h1>
    </div>
    <div className="row">
      <div className="col-md-4 mb40">
        <div className="panel">
          <div className="panel-title">Add Seat Type</div>
          <div className="panel-body">
            <form action="/admin/module/flight/seat-type/store/-1" method="post">
              <input type="hidden" name="_token" defaultValue="XBK8dcjcVCB87sJUxYEN7ivpa5LgyyCmPDX0gMbc" />
              <div className="form-group">
                <label>Name</label>
                <input type="text" defaultValue placeholder="Name" name="name" className="form-control" />
              </div>
              <div className="form-group">
                <label>Code</label>
                <input type="text" defaultValue placeholder="Code" name="code" className="form-control" required />
              </div>
              <div className>
