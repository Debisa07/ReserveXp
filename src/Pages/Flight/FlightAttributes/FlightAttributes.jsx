                ...
                <div className="main-content">
                    ...
                    <nav className="main-breadcrumb" aria-label="breadcrumb">
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item ">
                                <a href="/admin/module/Flight">Flight</a>
                            </li>
                    ...
                    <div className="container-fluid">
                        <div className="d-flex justify-content-between mb20">
                            <h1 className="title-bar">Flight Attributes</h1>
                        </div>
                        <div className="row">
                            <div className="col-md-4 mb40">
                                <div className="panel">
                                    ...
                                    <div className="panel-body">
                                        <form
                                            action="/admin/module/Flight/attribute/store/-1"
                                            method="post"
                                        >
                                            <input
                                                type="hidden"
                            ...
                            <div className="col-md-8"> 
                                ...
                                {/* <div className="filter-div d-flex justify-content-between ">
                                    <div className="col-left">
                                        <form
                                            method="post"
                                            action="/admin/module/Flight/attribute/editAttrBulk"
                                    ...
                                    <div className="col-left">
                                        <form
                                            method="get"
                                            action="/admin/module/Flight/attribute"
                                            ...
                                            <table className="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="title">
                                                            <a href="/admin/module/Flight/attribute/edit/6">
                                                                Facilities
                                                            </a>
                                                        </td>
                                                        <td>0</td>
                                                        <td>
                                                            <a
                                                                href="/admin/module/Flight/attribute/edit/6"
                                                                className="btn btn-primary btn-sm"
                                                            >
                                                                <i className="fa fa-edit" /> Edit
                                                            </a>
                                                            <a
                                                                href="/admin/module/Flight/attribute/terms/6"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="title">
                                                            <a href="/admin/module/Flight/attribute/edit/7">
                                                                Flight Service
                                                            </a>
                                                        </td>
                                                        <td>0</td>
                                                        <td>
                                                            <a
                                                                href="/admin/module/Flight/attribute/edit/7"
                                                                className="btn btn-primary btn-sm"
                                                            >
                                                                <i className="fa fa-edit" /> Edit
                                                            </a>
                                                            <a
                                                                href="/admin/module/Flight/attribute/terms/7"
                                                                className="btn btn-sm btn-success"
                                                            >
                                                                <i className="fa fa" /> Manage Terms
                                                            </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="title">
                                                            <a href="/admin/module/Flight/attribute/edit/5">
                                                                Property type
                                                            </a>
                                                        </td>
                                                        <td>0</td>
                                                        <td>
                                                            <a
                                                                href="/admin/module/Flight/attribute/edit/5"
                                                                className="btn btn-primary btn-sm"
                                                            >
                                                                <i className="fa fa-edit" /> Edit
                                                            </a>
                                                            <a
                                                                href="/admin/module/Flight/attribute/terms/5"
                                                                className="btn btn-sm btn-success"
                                                            >
                                                                <i className="fa fa" /> Manage Terms
                                                            </a>
