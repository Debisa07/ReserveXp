                ...
                >
                    ...
                    <div className="dashboard__main">
                        <div className="dashboard__content bg-light-2">
                            <h2 className="title-bar" style={{ fontSize: "32px" }}><b>Update verification data</b></h2>
                                        ...
                                        <div className="row align-items-center">
                                            ...
                                            <div className="col-md-4 btn-upload-private-wrap">
                                                ...
                                                <span className="btn btn-primary btn-sm ">
                                                    ...
                                                    <input
                                                        className="btn-upload-private-file has-value"
                                                        data-name="verify_data_id_card"
                                                        data-multiple=""
                                                        type="file"
                                                    />
                                                </span>
                                            ...
                                            <div className="col-md-4 btn-upload-private-wrap">
                                                ...
                                                <span className="btn btn-primary btn-sm ">
                                                    ...
                                                    <input
                                                        className="btn-upload-private-file has-value"
                                                        multiple=""
                                                        data-name="verify_data_trade_license[]"
                                                        data-multiple="true"
                                                        type="file"
                                                    />
                                                </span>
                                ...
                                <div className="modal-dialog" role="document">
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-body">
                                            <input
                                                type="text"
                                                name="verified_phone_code"
                                                className="form-control"
                                                id="verified_phone_code"
                                                defaultValue=""
                                            />
                                            <input
                                                type="hidden"
