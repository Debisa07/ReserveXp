...
import im1 from "../../../assets/image/vt.png";
import im2 from "../../../assets/image/vt-1.png";
import im3 from "../../../assets/image/vt-2.png";
import im4 from "../../../assets/image/vt-3.png";

import './Component.css'; // Make sure to import your CSS file
export default function AdminDashbord() {
  ...
  <nav className="main-breadcrumb" aria-label="breadcrumb">
    <ol className="breadcrumb">
      ...
      <li className="breadcrumb-item ">
        <a href="/admin/module/boat">Boats</a>
      </li>
  ...
  <form action="/admin/module/boat/store/-1" method="post">
    ...
    <div className="container-fluid">
      <div className="d-flex justify-content-between mb20">
        <div className>
          <h1 className="title-bar">Add new boat</h1>
        </div>
        <div className>
        </div>
      </div>
      <div className="lang-content-box">
        <div className="row">
          <div className="col-md-9">
            <div className="panel">
              <div className="panel-title"><strong>Boat Content</strong></div>
              <div className="panel-body">
                <div className="form-group">
                  <label>Title</label>
                  <input type="text"placeholder="Name of the boat" name="title" className="form-control" />
                </div>
                <div className="form-group">
                  <label className="control-label">Content</label>
                  <div className>
                    <textarea name="content" className="d-none has-ckeditor" cols={30} rows={10} id="xCpGJaLhOO" style={{"display":"none"}} aria-hidden="true" defaultValue={""} />
                    <div role="application" className="tox tox-tinymce" style={{"visibility":"hidden","height":"300px"}}>
                      <div className="tox-editor-container">
                        <div role="menubar" data-alloy-tabstop="true" className="tox-menubar"><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">File</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Edit</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">View</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Insert</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Format</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Tools</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Table</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Help</span>
                            <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                                <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                              </svg></div>
                          </button></div>
                        <div role="group" className="tox-toolbar-overlord">
                          <div role="group" className="tox-toolbar__primary">
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button title="Blocks" aria-label="Blocks" aria-haspopup="true" type="button" unselectable="on" tabIndex={-1} className="tox-tbtn tox-tbtn--select tox-tbtn--bespoke" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-tbtn__select-label">Paragraph</span>
                                <div className="tox-tbtn__select-chevron"><svg width={10} height={10}>
                                    <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                  </svg></div>
                              </button></div>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Bold" title="Bold" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M7.8 19c-.3 0-.5 0-.6-.2l-.2-.5V5.7c0-.2 0-.4.2-.5l.6-.2h5c1.5 0 2.7.3 3.5 1 .7.6 1.1 1.4 1.1 2.5a3 3 0 0 1-.6 1.9c-.4.6-1 1-1.6 1.2.4.1.9.3 1.3.6s.8.7 1 1.2c.4.4.5 1 .5 1.6 0 1.3-.4 2.3-1.3 3-.8.7-2.1 1-3.8 1H7.8zm5-8.3c.6 0 1.2-.1 1.6-.5.4-.3.6-.7.6-1.3 0-1.1-.8-1.7-2.3-1.7H9.3v3.5h3.4zm.5 6c.7 0 1.3-.1 1.7-.4.4-.4.6-.9.6-1.5s-.2-1-.7-1.4c-.4-.3-1-.4-2-.4H9.4v3.8h4z" fillRule="evenodd" />
                                  </svg></span></button><button aria-label="Italic" title="Italic" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  ...
                                  </svg></span></button><button aria-label="Strikethrough" title="Strikethrough" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <g fillRule="evenodd">
                              ...
                              <div aria-pressed="false" aria-label="Text color" title="Text color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_5079788221931698959846161">
                                <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                      <g fillRule="evenodd">
                                        <path id="tox-icon-text-color__color" d="M3 18h18v3H3z" />
                                        <path d="M8.7 16h-.8a.5.5 0 0 1-.5-.6l2.7-9c.1-.3.3-.4.5-.4h2.8c.2 0 .4.1.5.4l2.7 9a.5.5 0 0 1-.5.6h-.8a.5.5 0 0 1-.4-.4l-.7-2.2c0-.3-.3-.4-.5-.4h-3.4c-.2 0-.4.1-.5.4l-.7 2.2c0 .3-.2.4-.4.4zm2.6-7.6l-.6 2a.5.5 0 0 0 .5.6h1.6a.5.5 0 0 0 .5-.6l-.6-2c0-.3-.3-.4-.5-.4h-.4c-.2 0-.4.1-.5.4z">
                                        </path>
                                      </g>
                                    </svg></span></span><span role="presentation" tabIndex={-1} className="tox-tbtn tox-split-button__chevron"><svg width={10} height={10}>
                                    <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                  </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_5079788221931698959846161">To open
                                  the popup, press Shift+Enter</span></div>
                              <div aria-pressed="false" aria-label="Background color" title="Background color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_7332147941951698959846165">
                                <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                      <g fillRule="evenodd">
                                        <path id="tox-icon-highlight-bg-color__color" d="M3 18h18v3H3z" />
                                    ...
                                    <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                  </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_7332147941951698959846165">To open
                                  the popup, press Shift+Enter</span></div>
                            </div>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Insert/edit link" title="Insert/edit link" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  ...
                                  </svg></span></button><button aria-label="Insert/edit image" title="Insert/edit image" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M5 15.7l3.3-3.2c.3-.3.7-.3 1 0L12 15l4.1-4c.3-.4.8-.4 1 0l2 1.9V5H5v10.7zM5 18V19h3l2.8-2.9-2-2L5 17.9zm14-3l-2.5-2.4-6.4 6.5H19v-4zM4 3h16c.6 0 1 .4 1 1v16c0 .6-.4 1-1 1H4a1 1 0 0 1-1-1V4c0-.6.4-1 1-1zm6 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" fillRule="nonzero" />
                                  </svg></span></button><button aria-label="Insert/edit media" title="Insert/edit media" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M4 3h16c.6 0 1 .4 1 1v16c0 .6-.4 1-1 1H4a1 1 0 0 1-1-1V4c0-.6.4-1 1-1zm1 2v14h14V5H5zm4.8 2.6l5.6 4a.5.5 0 0 1 0 .8l-5.6 4A.5.5 0 0 1 9 16V8a.5.5 0 0 1 .8-.4z" fillRule="nonzero" />
                                  </svg></span></button></div>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Align left" title="Align left" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  ...
                                  </svg></span></button><button aria-label="Align center" title="Align center" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  ...
                                  </svg></span></button><button aria-label="Align right" title="Align right" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  ...
                                  </svg></span></button><button aria-label="Justify" title="Justify" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M5 5h14c.6 0 1 .4 1 1s-.4 1-1 1H5a1 1 0 1 1 0-2zm0 4h14c.6 0 1 .4 1 1s-.4 1-1 1H5a1 1 0 1 1 0-2zm0 4h14c.6 0 1 .4 1 1s-.4 1-1 1H5a1 1 0 0 1 0-2zm0 4h14c.6 0 1 .4 1 1s-.4 1-1 1H5a1 1 0 0 1 0-2z" fillRule="evenodd" />
                                  </svg></span></button></div>
                            <div role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="More..." title="More..." type="button" data-alloy-tabstop="true" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M6 10a2 2 0 0 0-2 2c0 1.1.9 2 2 2a2 2 0 0 0 2-2 2 2 0 0 0-2-2zm12 0a2 2 0 0 0-2 2c0 1.1.9 2 2 2a2 2 0 0 0 2-2 2 2 0 0 0-2-2zm-6 0a2 2 0 0 0-2 2c0 1.1.9 2 2 2a2 2 0 0 0 2-2 2 2 0 0 0-2-2z" fillRule="nonzero" />
                                  </svg></span></button></div>
                          </div>
                          <div role="group" className="tox-toolbar__overflow tox-toolbar__overflow--closed" style={{"height":"0px"}}>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group">
                              <div aria-pressed="false" aria-label="Numbered list" title="Numbered list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_7599494561971698959846187">
                                <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                      <path d="M10 17h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0-6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0-6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 1 1 0-2zM6 4v3.5c0 .3-.2.5-.5.5a.5.5 0 0 1-.5-.5V5h-.5a.5.5 0 0 1 0-1H6zm-1 8.8l.2.2h1.3c.3 0 .5.2.5.5s-.2.5-.5.5H4.9a1 1 0 0 1-.9-1V13c0-.4.3-.8.6-1l1.2-.4.2-.3a.2.2 0 0 0-.2-.2H4.5a.5.5 0 0 1-.5-.5c0-.3.2-.5.5-.5h1.6c.5 0 .9.4.9 1v.1c0 .4-.3.8-.6 1l-1.2.4-.2.3zM7 17v2c0 .6-.4 1-1 1H4.5a.5.5 0 0 1 0-1h1.2c.2 0 .3-.1.3-.3 0-.2-.1-.3-.3-.3H4.4a.4.4 0 1 1 0-.8h1.3c.2 0 .3-.1.3-.3 0-.2-.1-.3-.3-.3H4.5a.5.5 0 1 1 0-1H6c.6 0 1 .4 1 1z" fillRule="evenodd" />
                                    </svg></span></span><span role="presentation" tabIndex={-1} className="tox-tbtn tox-split-button__chevron"><svg width={10} height={10}>
                                    <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                  </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_7599494561971698959846187">To open
                                  the popup, press Shift+Enter</span></div>
                              <div aria-pressed="false" aria-label="Bullet list" title="Bullet list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_9768674451991698959846191">
                                <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    ...
                                    <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                  </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_9768674451991698959846191">To open
                                  the popup, press Shift+Enter</span></div>
                              <button aria-label="Decrease indent" title="Decrease indent" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M7 5h12c.6 0 1 .4 1 1s-.4 1-1 1H7a1 1 0 1 1 0-2zm5 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm0 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm-5 4h12a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2zm1.6-3.8a1 1 0 0 1-1.2 1.6l-3-2a1 1 0 0 1 0-1.6l3-2a1 1 0 0 1 1.2 1.6L6.8 12l1.8 1.2z" fillRule="evenodd" />
                                  </svg></span></button><button aria-label="Increase indent" title="Increase indent" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M7 5h12c.6 0 1 .4 1 1s-.4 1-1 1H7a1 1 0 1 1 0-2zm5 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm0 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm-5 4h12a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2zm-2.6-3.8L6.2 12l-1.8-1.2a1 1 0 0 1 1.2-1.6l3 2a1 1 0 0 1 0 1.6l-3 2a1 1 0 1 1-1.2-1.6z" fillRule="evenodd" />
                                  </svg></span></button>
                            </div>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Page break" title="Page break" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <g fillRule="evenodd">
                                  ...
                                  </svg></span></button><button aria-label="Insert/edit code sample" title="Insert/edit code sample" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={26}>
                                    <path d="M7.1 11a2.8 2.8 0 0 1-.8 2 2.8 2.8 0 0 1 .8 2v1.7c0 .3.1.6.4.8.2.3.5.4.8.4.3 0 .4.2.4.4v.8c0 .2-.1.4-.4.4-.7 0-1.4-.3-2-.8-.5-.6-.8-1.3-.8-2V15c0-.3-.1-.6-.4-.8-.2-.3-.5-.4-.8-.4a.4.4 0 0 1-.4-.4v-.8c0-.2.2-.4.4-.4.3 0 .6-.1.8-.4.3-.2.4-.5.4-.8V9.3c0-.7.3-1.4.8-2 .6-.5 1.3-.8 2-.8.3 0 .4.2.4.4v.8c0 .2-.1.4-.4.4-.3 0-.6.1-.8.4-.3.2-.4.5-.4.8V11zm9.8 0V9.3c0-.3-.1-.6-.4-.8-.2-.3-.5-.4-.8-.4a.4.4 0 0 1-.4-.4V7c0-.2.1-.4.4-.4.7 0 1.4.3 2 .8.5.6.8 1.3.8 2V11c0 .3.1.6.4.8.2.3.5.4.8.4.2 0 .4.2.4.4v.8c0 .2-.2.4-.4.4-.3 0-.6.1-.8.4-.3.2-.4.5-.4.8v1.7c0 .7-.3 1.4-.8 2-.6.5-1.3.8-2 .8a.4.4 0 0 1-.4-.4v-.8c0-.2.1-.4.4-.4.3 0 .6-.1.8-.4.3-.2.4-.5.4-.8V15a2.8 2.8 0 0 1 .8-2 2.8 2.8 0 0 1-.8-2zm-3.3-.4c0 .4-.1.8-.5 1.1-.3.3-.7.5-1.1.5-.4 0-.8-.2-1.1-.5-.4-.3-.5-.7-.5-1.1 0-.5.1-.9.5-1.2.3-.3.7-.4 1.1-.4.4 0 .8.1 1.1.4.4.3.5.7.5 1.2zM12 13c.4 0 .8.1 1.1.5.4.3.5.7.5 1.1 0 1-.1 1.6-.5 2a3 3 0 0 1-1.1 1c-.4.3-.8.4-1.1.4a.5.5 0 0 1-.5-.5V17a3 3 0 0 0 1-.2l.6-.6c-.6 0-1-.2-1.3-.5-.2-.3-.3-.7-.3-1 0-.5.1-1 .5-1.2.3-.4.7-.5 1.1-.5z" fillRule="evenodd" />
                                  </svg></span></button><button aria-label="Source code" title="Source code" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <g fillRule="nonzero">
                                      <path d="M9.8 15.7c.3.3.3.8 0 1-.3.4-.9.4-1.2 0l-4.4-4.1a.8.8 0 0 1 0-1.2l4.4-4.2c.3-.3.9-.3 1.2 0 .3.3.3.8 0 1.1L6 12l3.8 3.7zM14.2 15.7c-.3.3-.3.8 0 1 .4.4.9.4 1.2 0l4.4-4.1c.3-.3.3-.9 0-1.2l-4.4-4.2a.8.8 0 0 0-1.2 0c-.3.3-.3.8 0 1.1L18 12l-3.8 3.7z">
                                      </path>
                                    </g>
                                  </svg></span></button></div>
                            <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Clear formatting" title="Clear formatting" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                        ...
                        <div className="tox-sidebar-wrap">
                          <div className="tox-edit-area"><iframe id="xCpGJaLhOO_ifr" frameBorder={0} allowTransparency="true" title="Rich Text Area. Press ALT-0 for help." className="tox-edit-area__iframe" src="index_1.html" /></div>
                      ...
                      <div className="tox-statusbar">
                        <div className="tox-statusbar__text-container">
                          <div role="navigation" data-alloy-tabstop="true" className="tox-statusbar__path" /><button type="button" data-alloy-tabstop="true" tabIndex={-1} className="tox-statusbar__wordcount">0 words</button><span className="tox-statusbar__branding"><a href="https://www.tiny.cloud/?utm_campaign=editor_referral&utm_medium=poweredby&utm_source=tinymce&utm_content=v5" rel="noopener" target="_blank" tabIndex={-1} aria-label="Powered by Tiny">Powered by
                              Tiny</a></span>
                        </div>
                        <div title="Resize" className="tox-statusbar__resize-handle"><svg width={10} height={10}>
                            <g fillRule="nonzero">
                ...
                <div className="form-group">
                  <label className="control-label">Youtube Video</label>
                  <input type="text" name="video" className="form-control"placeholder="Youtube link video" />
                </div>
                <div className="form-group-item">
                  <label className="control-label">FAQs</label>
                  <div className="g-items-header">
                    <div className="row">
                  ...
                  <div className="g-items">
                    <div className="item" data-number={0}>
                      <div className="row">
                        <div className="col-md-5">
                          <input type="text" name="faqs[0][title]" className="form-control" placeholder="Eg: Can I bring my pet?"/>
                        </div>
                        <div className="col-md-6">
                          <textarea name="faqs[0][content]" className="form-control" placeholder defaultValue={""} />
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                  <span className="btn btn-info btn-sm btn-add-item"><i className="fa fa-plus-circle" />Add item</span>
                  </div>
                  <div className="g-more hide">
                    <div className="item" data-number="__number__">
                      <div className="row">
                        <div className="col-md-5">
                          <input type="text" __name__="faqs[__number__][title]" className="form-control" placeholder="Eg: Can I bring my pet?"/>
                        </div>
                        <div className="col-md-6">
                          <textarea __name__="faqs[__number__][content]" className="form-control" placeholder defaultValue={""} />
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                ...
                <div className="form-group">
                  ...
                  <div className="form-group-image">
                    <div className="dungdt-upload-box dungdt-upload-box-normal " data-val>
                      <div className="upload-box" v-show="!value">
                        <input type="hidden" name="banner_image_id" v-model="value"/>
                        <div className="text-center">
                          <svg id="next-dropzone" width="100%" height="100%">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 20">
                              ...
                              <path fill="#f8fafc" d="M10.056 14.67c.556-1.197 2.625-.98 3.8-1.905 1.054-.833 1.206-2.47 1.11-3.585-.892 1.387-3.517 1.62-4.738 2.87 0 0-1.875 2.064-1.71 3.157z">
                              </path>
                              <path fill="#f8fafc" d="M13.75 15.16c1.484-.318 2.64-1.482 2.946-2.97-.906.37-1.855.62-2.825.75-.8-.062-1.598.17-2.243.65-1.12.81-1.702 1.414-1.667 1.728zM2.177 15.833c.334.157.683.28 1.042.365.053.012.103.02.153.03.106.017.213.026.32.024l-.316.02h-.07z">
                              </path>
                              ...
                              <path fill="#e8eef5" d="M1.483 7.773c.767.856 2.727 1.704 1.992 2.237-.088.07-.16.16-.208.26-.256.456-.325 1.265-.333 1.92 0 .576.033 1.04.033 1.04l-1.11-1.122z">
                              </path>
                              ...
                              <path fill="#e8eef5" stroke="#d6dbeb" strokeWidth=".417" strokeLinecap="round" strokeLinejoin="round" d="M10.99 7.917c.417.11.833-.088 1.185-.338s.654-.56 1.042-.72l.392 1.287c.164.544.316 1.183-.022 1.64-.18.21-.408.376-.662.485-1.042.54-1.677 1.154-2.708 1.694.667-.294.665-1.098.75-1.823s-.08-1.458-.242-2.163">
                              </path>
                              ...
                              <path fill="none" stroke="#d6dbeb" strokeWidth=".417" strokeLinecap="round" strokeLinejoin="round" d="M10.99 7.917c.417.11.833-.088 1.185-.338s.654-.56 1.042-.72l.392 1.287c.164.544.316 1.183-.022 1.64-.18.21-.408.376-.662.485-1.042.54-1.677 1.154-2.708 1.694">
                              </path>
                              ...
                              <path fill="#d6dbeb" stroke="#d6dbeb" strokeWidth=".417" strokeLinecap="round" d="M18.333 8.635c-.37-.417-1.008-.583-1.59-.583-.156.014-.314 0-.465-.042-.162-.09-.312-.198-.446-.325-.335-.2-.738-.247-1.11-.133-.373.09-.715.26-1.083.358-.123.04-.253.052-.38.038-.158-.027-.296-.12-.452-.158-.344-.083-.723.123-1.042 0-.15-.088-.296-.185-.435-.29-.453-.238-.995.07-1.4.37 0 .007 8.416.786 8.403.766z">
                              </path>
                              <path fill="#f8fafc" d="M13.68 7.773c-.252-.3-.427-.66-.51-1.042-.06-.232-.07-.475-.026-.712.098-.458.442-.785.688-1.17.188-.293.165-.95.385-.982s.08.625.223.888c.092.165.22.3.31.465.178.37.217.792.108 1.19s-.27.774-.483 1.126z">
                              </path>
                              <path fill="#f8fafc" d="M15.154 7.5c.044-.438.61-.72.944-1.077.417-.454.47-1.042.36-1.612s-.294-1.693-.475-1.666c-.18.027-.177.69-.775 1.348-.28.308-.304.756-.27 1.154 0 0-.057 1.358-.526 1.875zM13.056 6.577L11.78 4.97c-.147.322-.23.67-.24 1.026.007.385.173.75.46 1.008.257.238.793.485.955.758z">
                              </path>
                              <path fill="#f8fafc" d="M15.708 7.596c.308-.43 1.106-.19 1.638-.467.477-.25.658-.884.704-1.33-.454.48-1.506.377-2.083.775 0 0-.896.673-.908 1.117z">
                              </path>
                              <path fill="#f8fafc" d="M17.125 8.065c.61-.014 1.152-.387 1.383-.95-.384.077-.777.105-1.17.083-.31-.084-.64-.053-.93.088-.5.237-.783.423-.783.558zM11.13 7.5c-.24-.224-.378-.535-.382-.862.365.134.742.23 1.127.283 0 0 .752.745 1.22.834z">
                              </path>
                              <path fill="#e8eef5" d="M13.467 5.27c.38-.176-.625-.786-.688-1.2-.257.395-.43.836-.51 1.3l.755 1.126s.1-1.07.442-1.225z">
                              </path>
                              ...
                              <path fill="#e8eef5" stroke="#d6dbeb" strokeWidth=".417" strokeLinecap="round" strokeLinejoin="round" d="M16.58 5c.166.063.35.05.503-.04.147-.088.303-.158.467-.208l.058.538c.025.227.037.49-.13.644-.088.07-.19.118-.3.142-.447.135-.745.33-1.193.465.285-.066.344-.382.43-.662.073-.284.096-.577.068-.87">
                              </path>
                              ...
                              <path fill="#fff" d="M11.34 10.44l.267 1.096s.015.48 0 .72c-.023.222-.058.444-.104.664-.208 1.065-.042.752-.248 1.817-.894-.257-1.78-.544-2.654-.862.092-.954.32-1.89.678-2.78 0 0 .346-.597.583-.984l1.48.332z">
                              </path>
                        ...
                        <div className="text-center">
                          <span className="btn btn-primary btn-field-upload">Upload image</span>
                        </div>
                      </div>
                      <div className="attach-demo" title="Change file">
                      </div>
                      <div className="upload-actions justify-content-between" v-show="value">
                        <a className="edit-img btn btn-sm btn-primary edit-single" data-file><i className="fa fa-edit" /></a>
                        <a className="delete btn btn-sm btn-danger"><i className="fa fa-trash" /></a>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="form-group">
                  ...
                  <div className="dungdt-upload-multiple " data-val>
                    <div className="attach-demo d-flex">
                    </div>
                    <div className="upload-box" v-show="!value">
                      <input type="hidden" name="gallery" v-model="value"/>
                      <div className="text-left">
                        <span className="btn btn-info btn-sm btn-field-upload"><i className="fa fa-plus-circle" />
                          Select images</span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="panel">
              <div className="panel-title"><strong>Extra Info</strong></div>
              <div className="panel-body">
                <div className="row">
                  <div className="col-md-3">
                    <div className="form-group">
                      <label>Guest</label>
                      <input type="number"placeholder="Example: 3" name="max_guest" className="form-control" />
                    </div>
                  </div>
                  <div className="col-md-3">
                    <div className="form-group">
                      <label>Cabin</label>
                      <input type="text"placeholder="Example: 5" name="cabin" className="form-control" />
                    </div>
                  </div>
                  <div className="col-md-3">
                    <div className="form-group">
                      <label>Length</label>
                      <input type="number"placeholder="Example: 30m" name="length" className="form-control" />
                    </div>
                  </div>
                  <div className="col-md-3">
                    <div className="form-group">
                      <label>Speed</label>
                      <input type="number"placeholder="Example: 25km/h" name="speed" className="form-control" />
                    </div>
                  </div>
                </div>
                <div className="form-group-item">
                  <label className="control-label">Specs</label>
                  <div className="g-items-header">
                    <div className="row">
                      <div className="col-md-5">Title</div>
                      <div className="col-md-5">Content</div>
                  ...
                  <div className="g-items">
                    <div className="item" data-number={0}>
                      <div className="row">
                        <div className="col-md-5">
                          <input type="text" name="specs[0][title]" className="form-control" placeholder="Eg: Range"/>
                        </div>
                        <div className="col-md-6">
                          <input type="text" name="specs[0][content]" className="form-control"placeholder="Eg: 6000km" />
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                  ...
                  <div className="g-more hide">
                    <div className="item" data-number="__number__">
                      <div className="row">
                        <div className="col-md-5">
                          <input type="text" __name__="specs[__number__][title]" className="form-control" placeholder="Eg: Range"/>
                        </div>
                        <div className="col-md-6">
                          <input type="text" __name__="specs[__number__][content]" className="form-control"placeholder="Eg: 6000km" />
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                ...
                <div className="form-group">
                  ...
                  <textarea name="cancel_policy" className="form-control" rows={5} placeholder="Full refund up to 4 days prior." defaultValue={""} />
                </div>
                <div className="form-group">
                  <label>Additional Terms &amp; Information</label>
                  <textarea name="terms_information" className="d-none has-ckeditor" rows={10} placeholder="For Sanitary purposes ONLY, although there is a working toilet and shower, we've deactivated the shower and the toliet is for limited use (urine only..pardon the graphic detail!)..." id="ecbjnBlgg1" style={{"display":"none"}} aria-hidden="true" defaultValue={""} />
                  <div role="application" className="tox tox-tinymce" style={{"visibility":"hidden","height":"300px"}}>
                    <div className="tox-editor-container">
                      <div role="menubar" data-alloy-tabstop="true" className="tox-menubar">
                        <button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">File</span>
                          <div className="tox-mbtn__select-chevron"><svg width={10} height={10}>
                              <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                            </svg></div>
                        </button><button aria-haspopup="true" role="menuitem" type="button" unselectable="on" tabIndex={-1} className="tox-mbtn tox-mbtn--select" style={{"-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} aria-expanded="false"><span className="tox-mbtn__select-label">Edit</span>
                      ...
                      <div role="group" className="tox-toolbar-overlord">
                        <div role="group" className="tox-toolbar__primary">
                          ...
                          <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Bold" title="Bold" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                            ...
                            <div aria-pressed="false" aria-label="Text color" title="Text color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_7210247282891698959847488">
                              <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <g fillRule="evenodd">
                                      <path id="tox-icon-text-color__color" d="M3 18h18v3H3z" />
                                      <path d="M8.7 16h-.8a.5.5 0 0 1-.5-.6l2.7-9c.1-.3.3-.4.5-.4h2.8c.2 0 .4.1.5.4l2.7 9a.5.5 0 0 1-.5.6h-.8a.5.5 0 0 1-.4-.4l-.7-2.2c0-.3-.3-.4-.5-.4h-3.4c-.2 0-.4.1-.5.4l-.7 2.2c0 .3-.2.4-.4.4zm2.6-7.6l-.6 2a.5.5 0 0 0 .5.6h1.6a.5.5 0 0 0 .5-.6l-.6-2c0-.3-.3-.4-.5-.4h-.4c-.2 0-.4.1-.5.4z">
                                  ...
                                  <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_7210247282891698959847488">To open the
                                popup, press Shift+Enter</span></div>
                            <div aria-pressed="false" aria-label="Background color" title="Background color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_3615141742911698959847502">
                              <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <g fillRule="evenodd">
                                      <path id="tox-icon-highlight-bg-color__color" d="M3 18h18v3H3z" />
                                      <path fillRule="nonzero" d="M7.7 16.7H3l3.3-3.3-.7-.8L10.2 8l4 4.1-4 4.2c-.2.2-.6.2-.8 0l-.6-.7-1.1 1.1zm5-7.5L11 7.4l3-2.9a2 2 0 0 1 2.6 0L18 6c.7.7.7 2 0 2.7l-2.9 2.9-1.8-1.8-.5-.6">
                                  ...
                                  <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_3615141742911698959847502">To open the
                                popup, press Shift+Enter</span></div>
                          </div>
                          <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Insert/edit link" title="Insert/edit link" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  <path d="M6.2 12.3a1 1 0 0 1 1.4 1.4l-2.1 2a2 2 0 1 0 2.7 2.8l4.8-4.8a1 1 0 0 0 0-1.4 1 1 0 1 1 1.4-1.3 2.9 2.9 0 0 1 0 4L9.6 20a3.9 3.9 0 0 1-5.5-5.5l2-2zm11.6-.6a1 1 0 0 1-1.4-1.4l2-2a2 2 0 1 0-2.6-2.8L11 10.3a1 1 0 0 0 0 1.4A1 1 0 1 1 9.6 13a2.9 2.9 0 0 1 0-4L14.4 4a3.9 3.9 0 0 1 5.5 5.5l-2 2z" fillRule="nonzero" />
                        ...
                        <div role="group" className="tox-toolbar__overflow tox-toolbar__overflow--closed" style={{"height":"0px"}}>
                          <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group">
                            <div aria-pressed="false" aria-label="Numbered list" title="Numbered list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_5188959112931698959847589">
                              <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M10 17h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0-6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0-6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 1 1 0-2zM6 4v3.5c0 .3-.2.5-.5.5a.5.5 0 0 1-.5-.5V5h-.5a.5.5 0 0 1 0-1H6zm-1 8.8l.2.2h1.3c.3 0 .5.2.5.5s-.2.5-.5.5H4.9a1 1 0 0 1-.9-1V13c0-.4.3-.8.6-1l1.2-.4.2-.3a.2.2 0 0 0-.2-.2H4.5a.5.5 0 0 1-.5-.5c0-.3.2-.5.5-.5h1.6c.5 0 .9.4.9 1v.1c0 .4-.3.8-.6 1l-1.2.4-.2.3zM7 17v2c0 .6-.4 1-1 1H4.5a.5.5 0 0 1 0-1h1.2c.2 0 .3-.1.3-.3 0-.2-.1-.3-.3-.3H4.4a.4.4 0 1 1 0-.8h1.3c.2 0 .3-.1.3-.3 0-.2-.1-.3-.3-.3H4.5a.5.5 0 1 1 0-1H6c.6 0 1 .4 1 1z" fillRule="evenodd" />
                                  </svg></span></span><span role="presentation" tabIndex={-1} className="tox-tbtn tox-split-button__chevron"><svg width={10} height={10}>
                                  <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_5188959112931698959847589">To open the
                                popup, press Shift+Enter</span></div>
                            <div aria-pressed="false" aria-label="Bullet list" title="Bullet list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_2868849822951698959847620">
                              <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                    <path d="M11 5h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0 6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zm0 6h8c.6 0 1 .4 1 1s-.4 1-1 1h-8a1 1 0 0 1 0-2zM4.5 6c0-.4.1-.8.4-1 .3-.4.7-.5 1.1-.5.4 0 .8.1 1 .4.4.3.5.7.5 1.1 0 .4-.1.8-.4 1-.3.4-.7.5-1.1.5-.4 0-.8-.1-1-.4-.4-.3-.5-.7-.5-1.1zm0 6c0-.4.1-.8.4-1 .3-.4.7-.5 1.1-.5.4 0 .8.1 1 .4.4.3.5.7.5 1.1 0 .4-.1.8-.4 1-.3.4-.7.5-1.1.5-.4 0-.8-.1-1-.4-.4-.3-.5-.7-.5-1.1zm0 6c0-.4.1-.8.4-1 .3-.4.7-.5 1.1-.5.4 0 .8.1 1 .4.4.3.5.7.5 1.1 0 .4-.1.8-.4 1-.3.4-.7.5-1.1.5-.4 0-.8-.1-1-.4-.4-.3-.5-.7-.5-1.1z" fillRule="evenodd" />
                                  </svg></span></span><span role="presentation" tabIndex={-1} className="tox-tbtn tox-split-button__chevron"><svg width={10} height={10}>
                                  <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                </svg></span><span aria-hidden="true" style={{"display":"none"}} id="aria_2868849822951698959847620">To open the
                                popup, press Shift+Enter</span></div><button aria-label="Decrease indent" title="Decrease indent" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  <path d="M7 5h12c.6 0 1 .4 1 1s-.4 1-1 1H7a1 1 0 1 1 0-2zm5 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm0 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm-5 4h12a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2zm1.6-3.8a1 1 0 0 1-1.2 1.6l-3-2a1 1 0 0 1 0-1.6l3-2a1 1 0 0 1 1.2 1.6L6.8 12l1.8 1.2z" fillRule="evenodd" />
                                </svg></span></button><button aria-label="Increase indent" title="Increase indent" type="button" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                  <path d="M7 5h12c.6 0 1 .4 1 1s-.4 1-1 1H7a1 1 0 1 1 0-2zm5 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm0 4h7c.6 0 1 .4 1 1s-.4 1-1 1h-7a1 1 0 0 1 0-2zm-5 4h12a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2zm-2.6-3.8L6.2 12l-1.8-1.2a1 1 0 0 1 1.2-1.6l3 2a1 1 0 0 1 0 1.6l-3 2a1 1 0 1 1-1.2-1.6z" fillRule="evenodd" />
                                </svg></span></button>
                      ...
                      <div className="tox-anchorbar" />
                      <div className="tox-sidebar-wrap">
                        <div className="tox-edit-area"><iframe id="ecbjnBlgg1_ifr" frameBorder={0} allowTransparency="true" title="Rich Text Area. Press ALT-0 for help." className="tox-edit-area__iframe" src="index_2.html" /></div>
                        <div role="complementary" className="tox-sidebar">
                          <div data-alloy-tabstop="true" tabIndex={-1} className="tox-sidebar__slider tox-sidebar--sliding-closed" style={{"width":"0px"}}>
                            <div className="tox-sidebar__pane-container" />
                          </div>
                ...
                <div className="form-group-item">
                  <label className="control-label">Include</label>
                  <div className="g-items-header">
                    <div className="row">
                      <div className="col-md-11 text-left">Title</div>
                      <div className="col-md-1" />
                    </div>
                  </div>
                  <div className="g-items">
                    <div className="item" data-number={0}>
                      <div className="row">
                        <div className="col-md-11">
                          <input type="text" name="include[0][title]" className="form-control" placeholder="Eg: Specialized bilingual guide"/>
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                  ...
                  <div className="g-more hide">
                    <div className="item" data-number="__number__">
                      <div className="row">
                        <div className="col-md-11">
                          <input type="text" __name__="include[__number__][title]" className="form-control" placeholder="Eg: Specialized bilingual guide"/>
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                ...
                <div className="form-group-item">
                  ...
                  <div className="g-items">
                    <div className="item" data-number={0}>
                      <div className="row">
                        <div className="col-md-11">
                          <input type="text" name="exclude[0][title]" className="form-control" placeholder="Eg: Additional Services"/>
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
                  ...
                  <div className="g-more hide">
                    <div className="item" data-number="__number__">
                      <div className="row">
                        <div className="col-md-11">
                          <input type="text" __name__="exclude[__number__][title]" className="form-control" placeholder="Eg: Additional Services"/>
                        </div>
                        <div className="col-md-1">
                          <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                        </div>
            ...
            <div className="panel">
              <div className="panel-title"><strong>Locations</strong></div>
              <div className="panel-body">
                <div className="form-group">
                ...
                <div className="form-group">
                  <label className="control-label">Real address</label>
                  <input type="text" name="address" id="customPlaceAddress" className="form-control pac-target-input" placeholder="Real address"autoComplete="off" />
                </div>
                <div className="form-group">
                  <label className="control-label">The geographic coordinate</label>
                    ...
                    <div id="map_content" style={{"position":"relative","overflow":"hidden"}}>
                      <div style={{"height":"100%","width":"100%","position":"absolute","top":"0px","left":"0px","background-color":"rgb(229, 227, 223)"}}>
                        <div style={{"position":"absolute","z-index":"0","left":"0px","top":"0px","height":"100%","width":"100%","padding":"0px","border-width":"0px","margin":"0px"}} className="gm-style">
                          <div><button style={{"background":"transparent","display":"block","border":"medium","margin":"0px","padding":"0px","-webkit-text-transform":"none","text-transform":"none","-webkit-appearance":"none","-moz-appearance":"none","appearance":"none","position":"absolute","cursor":"pointer","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none","z-index":"1000002","outline-offset":"3px","right":"0px","bottom":"0px","-webkit-transform":"translateX(100%)","-ms-transform":"translateX(100%)","transform":"translateX(100%)"}} draggable="false" aria-label="Keyboard shortcuts" title="Keyboard shortcuts" type="button" />
                          </div>
                          <div style={{"position":"absolute","z-index":"0","left":"0px","top":"0px","height":"100%","width":"100%","padding":"0px","border-width":"0px","margin":"0px","cursor":"url(\"openhand_8_8.cur.bmp\"), default","touch-action":"pan-x pan-y"}} tabIndex={0} aria-label="Map" aria-roledescription="map" role="region" aria-describedby="8F32ED21-E00A-4A05-BDF9-3617D435A488">
                            <div style={{"z-index":"1","position":"absolute","left":"50%","top":"50%","width":"100%","will-change":"transform","-webkit-transform":"translate(0px)","-ms-transform":"translate(0px)","transform":"translate(0px)"}}>
                              <div style={{"position":"absolute","left":"0px","top":"0px","z-index":"100","width":"100%"}}>
                                <div style={{"position":"absolute","left":"0px","top":"0px","z-index":"0"}}>
                                  <div style={{"position":"absolute","z-index":"992","-webkit-transform":"matrix(1, 0, 0, 1, -240, -33)","-ms-transform":"matrix(1, 0, 0, 1, -240, -33)","transform":"matrix(1, 0, 0, 1, -240, -33)"}}>
                              ...
                              <div style={{"position":"absolute","left":"0px","top":"0px","z-index":"0"}}>
                                <div style={{"position":"absolute","z-index":"992","-webkit-transform":"matrix(1, 0, 0, 1, -240, -33)","-ms-transform":"matrix(1, 0, 0, 1, -240, -33)","transform":"matrix(1, 0, 0, 1, -240, -33)"}}>
                                  <div style={{"position":"absolute","left":"256px","top":"0px","width":"256px","height":"256px","-webkit-transition":"opacity 200ms linear 0s","transition":"opacity 200ms linear 0s"}}>
                                    <img style={{"width":"256px","height":"256px","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none","border":"0px","padding":"0px","margin":"0px","max-width":"none"}} draggable="false" alt role="presentation" src="vt.png" />
                                  </div>
                                  <div style={{"position":"absolute","left":"0px","top":"0px","width":"256px","height":"256px","-webkit-transition":"opacity 200ms linear 0s","transition":"opacity 200ms linear 0s"}}>
                                    <img style={{"width":"256px","height":"256px","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none","border":"0px","padding":"0px","margin":"0px","max-width":"none"}} draggable="false" alt role="presentation" src="vt-1.png" />
                                  </div>
                                  <div style={{"position":"absolute","left":"256px","top":"-256px","width":"256px","height":"256px","-webkit-transition":"opacity 200ms linear 0s","transition":"opacity 200ms linear 0s"}}>
                                    <img style={{"width":"256px","height":"256px","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none","border":"0px","padding":"0px","margin":"0px","max-width":"none"}} draggable="false" alt role="presentation" src="vt-2.png" />
                                  </div>
                                  <div style={{"position":"absolute","left":"0px","top":"-256px","width":"256px","height":"256px","-webkit-transition":"opacity 200ms linear 0s","transition":"opacity 200ms linear 0s"}}>
                                    <img style={{"width":"256px","height":"256px","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none","border":"0px","padding":"0px","margin":"0px","max-width":"none"}} draggable="false" alt role="presentation" src="vt-3.png" />
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div style={{"z-index":"3","position":"absolute","height":"100%","width":"100%","padding":"0px","border-width":"0px","margin":"0px","left":"0px","top":"0px","touch-action":"pan-x pan-y"}}>
                              <div style={{"z-index":"4","position":"absolute","left":"50%","top":"50%","width":"100%","will-change":"transform","-webkit-transform":"translate(0px)","-ms-transform":"translate(0px)","transform":"translate(0px)"}}>
                                ...
                                <div style={{"position":"absolute","left":"0px","top":"0px","z-index":"106","width":"100%"}}>
                                  <span id="3DD42850-796F-4D17-8CBB-F85FCC10EC98" style={{"display":"none"}}>To navigate,
                                    press the arrow keys.</span></div>
                            ...
                            <div className="LGLeeN-keyboard-shortcuts-view" id="8F32ED21-E00A-4A05-BDF9-3617D435A488" style={{"display":"none"}}>
                              <table>
                                <tbody>
                                  <tr>
                                    <td><kbd aria-label="Left arrow">←</kbd>
                                    </td>
                                    <td aria-label="Move left.">Move left
                                    </td>
                                  </tr>
                                  <tr>
                                    <td><kbd aria-label="Right arrow">→</kbd>
                                    </td>
                                    <td aria-label="Move right.">Move right
                                    </td>
                                  </tr>
                                  <tr>
                                    <td><kbd aria-label="Up arrow">↑</kbd>
                                    </td>
                                    <td aria-label="Move up.">Move up</td>
                                  </tr>
                                  <tr>
                                    <td><kbd aria-label="Down arrow">↓</kbd>
                                    </td>
                                    <td aria-label="Move down.">Move down
                                    </td>
                                  </tr>
                                  <tr>
                                    <td><kbd>+</kbd></td>
                                  ...
                                  <tr>
                                    ...
                                    <td aria-label="Jump up by 75%.">Jump up
                                      by 75%</td>
                                  </tr>
                                  <tr>
                          ...
                          </div><iframe aria-hidden="true" frameBorder={0} tabIndex={-1} style={{"z-index":"-1","position":"absolute","width":"100%","height":"100%","top":"0px","left":"0px","border":"medium"}} src="index_3.html" />
                          ...
                          <div>
                            <div style={{"margin":"0px 5px","z-index":"1000000","position":"absolute","left":"0px","bottom":"0px"}}>
                              <a style={{"display":"inline"}} target="_blank" rel="noopener" title="Open this area in Google Maps (opens a new window)" aria-label="Open this area in Google Maps (opens a new window)" href="https://maps.google.com/maps?ll=51.505,-0.09&z=8&t=m&hl=en-US&gl=US&mapclient=apiv3">
                          ...
                          <div>
                            <div style={{"display":"inline-flex","position":"absolute","right":"0px","bottom":"0px"}}>
                              ...
                              <div className="gmnoscreen">
                                ...
                                </div><span id="1F8982B1-AA7A-4B94-9F14-E0A35E168D83" style={{"display":"none"}}>Click to toggle
                                  between metric and imperial units</span>
                              </button>
                      ...
                      <div style={{"background-color":"white","font-weight":"500","font-family":"Roboto, sans-serif","padding":"15px 25px","box-sizing":"border-box","top":"5px","border":"1px solid rgba(0, 0, 0, 0.12)","border-radius":"5px","left":"50%","max-width":"375px","position":"absolute","-webkit-transform":"translateX(-50%)","-ms-transform":"translateX(-50%)","transform":"translateX(-50%)","width":"calc(100% - 10px)","z-index":"1"}}>
                        <div><img alt src="google_gray.svg" style={{"padding":"0px","margin":"0px","border":"0px","height":"17px","vertical-align":"middle","width":"52px","-webkit-user-select":"none","-moz-user-select":"none","-ms-user-select":"none","user-select":"none"}} draggable="false" /></div>
                        ...
                        <table style={{"width":"100%"}}>
                          <tbody><tr>
                              <td style={{"line-height":"16px","vertical-align":"middle"}}>
                                <a href="https://developers.google.com/maps/documentation/javascript/error-messages?utm_source=maps_js&utm_medium=degraded&utm_campaign=billing#api-key-and-billing-errors" target="_blank" rel="noopener" style={{"color":"rgba(0, 0, 0, 0.54)","font-size":"12px"}}>Do
                                  you own this website?</a></td>
                              <td style={{"-webkit-text-align":"right","text-align":"right"}}><button className="dismissButton">OK</button></td>
                            </tr>
                          </tbody></table>
                      </div>
                    </div>
                    <input type="text" placeholder="Search by name..." className="bravo_searchbox form-control pac-target-input" autoComplete="off"/>
                    <div className="g-control">
                      <div className="form-group">
                        <label>Map Latitude:</label>
                        <input type="text" name="map_lat" className="form-control"/>
                      </div>
                      <div className="form-group">
                        <label>Map Longitude:</label>
                        <input type="text" name="map_lng" className="form-control"/>
                      </div>
                      <div className="form-group">
                        <label>Map Zoom:</label>
                        <input type="text" name="map_zoom" className="form-control" defaultValue={8} />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="panel">
              <div className="panel-title"><strong>Pricing</strong></div>
              <div className="panel-body">
                <div className="row">
                  <div className="col-lg-6">
                    <div className="form-group">
                      <label className="control-label">Price per hour</label>
                      <input type="number" step="any" min={0} name="price_per_hour" className="form-control"placeholder="Price per hour" />
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="form-group">
                      <label className="control-label">Price per day</label>
                      <input type="number" step="any" name="price_per_day" className="form-control"placeholder="Price per day" />
                    </div>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-6">
                    <div className="form-group">
                      <label className="control-label">Minimum advance reservations</label>
                      <input type="number" name="min_day_before_booking" className="form-control"placeholder="Ex: 3" />
                      <i>Leave blank if you dont need to use the min day option</i>
                    </div>
                  </div>
                  <div className="col-lg-6">
                    <div className="row">
                      <div className="col-md-6">
                        <label className="control-label">Start time booking</label>
                        <select name="start_time_booking" className="form-control">
                      ...
                      <div className="col-md-6">
                        <label className="control-label">End time booking</label>
                        <select name="end_time_booking" className="form-control">
                          <option value selected="selected">-- Select --</option>
                          <option value="00:00">00:00</option>
                          <option value="00:30">00:30</option>
                          <option value="01:00">01:00</option>
                    ...
                    <i>*Leave it blank if don't use these fields. The end-time must be
                      larger than start-time</i>
                  </div>
                </div>
                <div className="form-group ">
                  <label><input type="checkbox" name="enable_extra_price" defaultValue={1} /> Enable
                    extra price
                  </label>
                </div>
                <div className="form-group-item " data-condition="enable_extra_price:is(1)" style={{"display":"none"}}>
                  <label className="control-label">Extra Price</label>
                  <div className="g-items-header">
                    <div className="row">
                      ...
                      <div className="row">
                        <div className="col-md-5">
                          <div className="g-lang">
                            <div className="title-lang">English</div>
                            <input type="text" __name__="extra_price[__number__][name]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Japanese</div>
                            <input type="text" __name__="extra_price[__number__][name_ja]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Egyptian</div>
                            <input type="text" __name__="extra_price[__number__][name_egy]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Turkish</div>
                            <input type="text" __name__="extra_price[__number__][name_tr]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Portugueses</div>
                            <input type="text" __name__="extra_price[__number__][name_pt_BR]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">فارسی</div>
                            <input type="text" __name__="extra_price[__number__][name_fa]" className="form-control"placeholder="Extra price name" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Vietnamese</div>
                            <input type="text" __name__="extra_price[__number__][name_vi]" className="form-control"placeholder="Extra price name" />
                          </div>
                        </div>
                        <div className="col-md-3">
                          <input type="number" min={0} __name__="extra_price[__number__][price]" className="form-control"/>
                        </div>
                        <div className="col-md-3">
                          <select __name__="extra_price[__number__][type]" className="form-control">
                            <option value="one_time" selected="selected">One-time
                            </option>
                          </select>
                        </div>
                        <div className="col-md-1">
                ...
                <hr />
                <h3 className="panel-body-title app_get_locale">Service fee</h3>
                <div className="form-group app_get_locale">
                  <label><input type="checkbox" name="enable_service_fee" defaultValue={1} /> Enable
                    service fee
                  </label>
                </div>
                <div className="form-group-item" data-condition="enable_service_fee:is(1)" style={{"display":"none"}}>
                  <label className="control-label">Buyer Fees</label>
                  <div className="g-items-header">
                    <div className="row">
                      <div className="col-md-7">Name</div>
                      <div className="col-md-4">Price</div>
                      <div className="col-md-3 d-none">Type</div>
                      <div className="col-md-1" />
                    </div>
                  </div>
                  <div className="g-items">
                    ...
                    <div className="item" data-number="__number__">
                      <div className="row">
                        <div className="col-md-7">
                          <div className="g-lang">
                            <div className="title-lang">English</div>
                            <input type="text" __name__="service_fee[__number__][name]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Japanese</div>
                            <input type="text" __name__="service_fee[__number__][name_ja]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_ja]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Egyptian</div>
                            <input type="text" __name__="service_fee[__number__][name_egy]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_egy]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Turkish</div>
                            <input type="text" __name__="service_fee[__number__][name_tr]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_tr]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Portugueses</div>
                            <input type="text" __name__="service_fee[__number__][name_pt_BR]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_pt_BR]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">فارسی</div>
                            <input type="text" __name__="service_fee[__number__][name_fa]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_fa]" className="form-control"placeholder="Fee desc" />
                          </div>
                          <div className="g-lang">
                            <div className="title-lang">Vietnamese</div>
                            <input type="text" __name__="service_fee[__number__][name_vi]" className="form-control"placeholder="Fee name" />
                            <input type="text" __name__="service_fee[__number__][desc_vi]" className="form-control"placeholder="Fee desc" />
                          </div>
                        </div>
                        <div className="col-md-4">
                          <input type="number" min={0} step="0.1" __name__="service_fee[__number__][price]" className="form-control"/>
                          <select __name__="service_fee[__number__][unit]" className="form-control">
                            <option value="fixed" selected="selected">Fixed</option>
                            <option value="percent">Percent</option>
                          </select>
                        </div>
                        <div className="col-md-3 d-none">
                          <select __name__="service_fee[__number__][type]" className="form-control">
                            <option value="one_time" selected="selected">One-time
                            </option>
                          </select>
                        </div>
          ...
          <div className="col-md-3">
            <div className="panel">
              <div className="panel-title"><strong>Publish</strong></div>
              <div className="panel-body">
                <div>
                  <label><input defaultChecked="checked" type="radio" name="status" defaultValue="publish" />
                    Publish
                  </label>
                </div>
                <div>
                  <label><input type="radio" name="status" defaultValue="draft" /> Draft
                  </label>
                </div>
                <div className="text-right">
                  <button className="btn btn-primary" type="submit"><i className="fa fa-save" />
                    Save Changes</button>
                </div>
              </div>
            </div>
            <div className="panel">
              <div className="panel-title"><strong>Author Setting</strong></div>
              <div className="panel-body">
                <div className="form-group">
                  <select id="select_author_id" className="form-control dungdt-select2-field select2-hidden-accessible" data-options="{&quot;ajax&quot;:{&quot;url&quot;:&quot;https:\/\/gotrip.bookingcore.co\/admin\/module\/user\/getForSelect2&quot;,&quot;dataType&quot;:&quot;json&quot;},&quot;allowClear&quot;:true,&quot;placeholder&quot;:&quot;-- Select User --&quot;}" name="author_id" data-select2-id="select_author_id" tabIndex={-1} aria-hidden="true">
                  </select><span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id={1} style={{"width":"192.5px"}}><span className="selection"><span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex={0} aria-labelledby="select2-select_author_id-container"><span className="select2-selection__rendered" id="select2-select_author_id-container" role="textbox" aria-readonly="true"><span className="select2-selection__placeholder">-- Select User
            ...
            <div className="panel">
              <div className="panel-title"><strong>Availability</strong></div>
              <div className="panel-body">
                <div className="form-group">
                  <label>Boat Featured</label>
                  <br />
                  <label>
                    <input type="checkbox" name="is_featured" defaultValue={1} /> Enable featured
                  </label>
                </div>
                <div className="form-group d-none">
                  <label>Is Instant Booking?</label>
                  <br />
                  <label>
                    <input type="checkbox" name="is_instant" defaultValue={1} /> Enable instant
                    booking
                  </label>
                </div>
                <div className="form-group">
                  ...
                  <br />
                  <select name="default_state" className="custom-select">
                    <option value>-- Please select --</option>
                    <option value={1}>Always available</option>
                    <option value={0} selected="selected">Only available on specific dates
                    </option>
                  </select>
                </div>
              </div>
            ...
            <div className="panel">
              <div className="panel-title"><strong>Attribute: Boat Type</strong></div>
              <div className="panel-body">
                <div className="terms-scrollable">
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={96} />
                    <span className="term-name">Airboat</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={97} />
                    <span className="term-name">Cabin cruiser</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={98} />
                    <span className="term-name">Cruise ship</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={99} />
                    <span className="term-name">Express cruiser</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={100} />
                    <span className="term-name">Electric boat</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={101} />
                    <span className="term-name">Ferry</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={102} />
                    <span className="term-name">Inflatable boat</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={103} />
                    <span className="term-name">Jetboat</span>
                  </label>
                </div>
              </div>
            </div>
            <div className="panel">
              <div className="panel-title"><strong>Attribute: Amenities</strong></div>
              <div className="panel-body">
                <div className="terms-scrollable">
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={104} />
                    <span className="term-name">Events and Meetings</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={105} />
                    <span className="term-name">Scuba Gear</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={106} />
                    <span className="term-name">Hot Tub/Jacuzzi on Deck</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={107} />
                    <span className="term-name">Sport Fishing</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={108} />
                    <span className="term-name">Speciality Classic Yacht</span>
                  </label>
                  <label className="term-item">
                    <input type="checkbox" name="terms[]" defaultValue={109} />
                    <span className="term-name">Gulet</span>
                  </label>
                </div>
              </div>
            </div>
            <div className="panel">
              <div className="panel-title"><strong>Feature Image</strong></div>
              <div className="panel-body">
                <div className="form-group">
                  <div className="dungdt-upload-box dungdt-upload-box-normal " data-val>
                    <div className="upload-box" v-show="!value">
                      <input type="hidden" name="image_id" v-model="value"/>
                      <div className="text-center">
                        <svg id="next-dropzone" width="100%" height="100%">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 20">
                            <path fill="#fff" d="M18.487 17.827c-.063.077-.148.133-.244.16-.267.053-.54.074-.81.065l-15.35 1.323c-.563.052-.596-.198-.637-.702l-.117-1.448-.418-5.07-.458-5.682C.346 5.13.246 3.79.127 2.448c-.027-.32-.07-.585.275-.702.335-.082.678-.125 1.023-.127l1.567-.132L13.05.626c.692-.06 1.383-.115 2.083-.17.58-.045 1.198-.222 1.78-.174.432.035.272.456.3.767l.057.674.17 1.996.46 5.352.418 4.85c.094 1.083.175 2.167.26 3.248.017.252.037.494-.092.658z">
