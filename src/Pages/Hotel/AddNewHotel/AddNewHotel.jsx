...
//   const submitHotel = (e) => {
//     try{
//       axios.post("http://localhost:4000/hotel", {
//   hotelName: hotelName,
//   location: location,
//   price: price,
//   images: images,
...
// })
//   .then((response) => {
//     alert(`Submit ${response.data.hotelName} successfully`);
          ...
          <form onSubmit={submitHotel}>
            <div className="container-fluid">
              <div className="d-flex justify-content-between mb20">
                <div className>
                  <h1 className="title-bar">Add new hotel</h1>
                </div>
                <div className>
                </div>
              </div>
              <div className="lang-content-box">
                <div className="row">
                  <div className="col-md-9">
                    <div className="panel">
                      <div className="panel-title"><strong>Hotel Content</strong></div>
                      <div className="panel-body">
                        <div className="form-group">
                          <label>Title</label>
                          <input type="text" placeholder="Name of the hotel" name="title" className="form-control" value={hotelName}
                            onChange={(e) => setHotelName(e.target.value)} />
                        </div>
                        <div className="form-group">
<label className="control-label">Content</label>
                  <textarea rows={3} placeholder="Enter description..." value={contentText}
                            onChange={(e) => setContentText(e.target.value)}/>
                          
                          {/* <div className>
                            <textarea name="content" className="d-none has-ckeditor" cols={30} rows={10} id="vom83eZhZ4" style={{ "display": "none" }} aria-hidden="true" />
                            <div role="application" className="tox tox-tinymce" style={{ "visibility": "hidden", "height": "300px" }}>
                              <div className="tox-editor-container">
                                ...
                                <div role="group" className="tox-toolbar-overlord">
                                  <div role="group" className="tox-toolbar__primary">
                                    ...
                                    <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group"><button aria-label="Bold" title="Bold" type="button" tabIndex={-1} className="tox-tbtn" aria-pressed="false"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                      ...
                                      <div aria-pressed="false" aria-label="Text color" title="Text color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_227477601751698853073458">
                                        <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                          ...
                                          <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                        </svg></span><span aria-hidden="true" style={{ "display": "none" }} id="aria_227477601751698853073458">To open
                                          the popup, press Shift+Enter</span></div>
                                      <div aria-pressed="false" aria-label="Background color" title="Background color" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_5552091551771698853073459">
                                        <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                          <g fillRule="evenodd">
                                          ...
                                          <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                        </svg></span><span aria-hidden="true" style={{ "display": "none" }} id="aria_5552091551771698853073459">To open
                                          the popup, press Shift+Enter</span></div>
                                    </div>
                                  ...
                                  <div role="group" className="tox-toolbar__overflow tox-toolbar__overflow--closed" style={{ "height": "0px" }}>
                                    <div title role="toolbar" data-alloy-tabstop="true" tabIndex={-1} className="tox-toolbar__group">
                                      <div aria-pressed="false" aria-label="Numbered list" title="Numbered list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_593982571791698853073462">
                                        <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                          ...
                                          <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                        </svg></span><span aria-hidden="true" style={{ "display": "none" }} id="aria_593982571791698853073462">To open
                                          the popup, press Shift+Enter</span></div>
                                      <div aria-pressed="false" aria-label="Bullet list" title="Bullet list" role="button" aria-haspopup="true" tabIndex={-1} className="tox-split-button" aria-expanded="false" aria-describedby="aria_635130931811698853073463">
                                        <span role="presentation" tabIndex={-1} className="tox-tbtn"><span className="tox-icon tox-tbtn__icon-wrap"><svg width={24} height={24}>
                                          ...
                                          <path d="M8.7 2.2c.3-.3.8-.3 1 0 .4.4.4.9 0 1.2L5.7 7.8c-.3.3-.9.3-1.2 0L.2 3.4a.8.8 0 0 1 0-1.2c.3-.3.8-.3 1.1 0L5 6l3.7-3.8z" fillRule="nonzero" />
                                        </svg></span><span aria-hidden="true" style={{ "display": "none" }} id="aria_635130931811698853073463">To open
                                          the popup, press Shift+Enter</span></div>
                                ...
                                <div className="tox-sidebar-wrap">
                                  <div className="tox-edit-area"><iframe id="vom83eZhZ4_ifr" frameBorder={0} allowTransparency="true" title="Rich Text Area. Press ALT-0 for help." className="tox-edit-area__iframe" src="index_1.html" /></div>
      ...
      {images.map((image, index) => (
        ...
        />
                      ...
                      <div className="dungdt-upload-multiple " data-val>
                        ...
                        <div className="upload-box" v-show="!value">
                          ...
                          <div className="text-left">
                            <span className="btn btn-info btn-sm btn-field-upload" >
                              Select images</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="panel">
                      <div className="panel-title"><strong>Hotel Policy</strong></div>
                      <div className="panel-body">
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <label>Hotel rating standard</label>
                              <input type="number" placeholder="Eg: 5" name="star_rate" className="form-control" />
                            </div>
                          </div>
                        </div>
                        <div className="form-group-item">
                          <label className="control-label">Policy</label>
                            ...
                            <div className="item" data-number={0}>
                              <div className="row">
                                <div className="col-md-5">
                                  <input type="text" style={{ border: "2px solid #DDE1EF" }} name="policy[0][title]" className="form-control" placeholder="Eg: What kind of foowear is most suitable ?" />
                                </div>
                                <div className="col-md-6">
                                  <textarea name="policy[0][content]" className="form-control" placeholder value={hotelPolicy}
                          ...
                          <div className="g-more hide">
                            <div className="item" data-number="__number__">
                              <div className="row">
                                <div className="col-md-5">
                                  <input type="text" __name__="policy[__number__][title]" className="form-control" placeholder="Eg: What kind of foowear is most suitable ?" />
                                </div>
                                <div className="col-md-6">
                                  <textarea __name__="policy[__number__][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-1">
                                  <span className="btn btn-danger btn-sm btn-remove-item"><i className="fa fa-trash" /></span>
                                </div>
                    ...
                    <div className="panel">
                      <div className="panel-title"><strong>Check in/out time</strong></div>
                      <div className="panel-body">
                        <div className="form-group d-none">
                          <label>Allowed full day booking</label>
                          <br />
                          <label>
                            <input type="checkbox" name="allow_full_day" /> Enable full day
                            booking
                          </label>
                          <div className="small">
                            You can book room with full day <br />
                            Eg: booking from 22-23, then all days 22 and 23 are full, other people
                            cannot book
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input type="text" placeholder="Eg: 12:00AM" name="check_in_time" className="form-control" value={checkInTime}
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input type="text" placeholder="Eg: 11:00AM" name="check_out_time" className="form-control" value={checkOutTime}
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-6">
                            <div className="form-group">
                              <label className="control-label">Minimum day stay requirements</label>
                              <input type="number" name="min_day_stays" className="form-control" placeholder="Ex: 2" />
                              <i>Leave blank if you dont need to set minimum day stay option</i>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="panel">
                      ...
                      <div className="panel-body">
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="form-group">
                              ...
                              <input type="number" step="any" min={0} name="price" className="form-control" placeholder="Hotel Price" value={price}
                          ...
                          <div className="col-lg-6 d-none">
                            <div className="form-group">
                              ...
                              <input type="number" step="any" name="sale_price" className="form-control" placeholder="Hotel Sale Price" />
                              <span><i>If the regular price is less than the discount , it will
                                show the regular price</i></span>
                            </div>
                          </div>
                        </div>
                        <div className="form-group ">
                          <label><input type="checkbox" name="enable_extra_price" defaultChecked="checked" /> Enable extra price
                          </label>
                        </div>
                        <div className="form-group-item " data-condition="enable_extra_price:is(1)" style={{}}>
                          ...
                          <div className="g-items">
                            <div className="item" data-number={0}>
                              <div className="row">
                                <div className="col-md-5">
                                  <input type="text" style={{ border: "2px solid #DDE1EF" }} name="extra_price[0][name]" className="form-control" placeholder="Extra price name" />
                                </div>
                                <div className="col-md-3">
                                  <input type="number" style={{ border: "2px solid #DDE1EF" }} min={0} name="extra_price[0][price]" className="form-control" />
                                </div>
                                <div className="col-md-3">
                                  <select name="extra_price[0][type]" className="form-control">
                                  ...
                                  <label>
                                    <input type="checkbox" min={0} name="extra_price[0][per_person]" defaultValue="on" />
                                    Price per person
                                  </label>
                                </div>
                                <div className="col-md-1">
                            ...
                            <div className="item" data-number="__number__">
                              <div className="row">
                                ...
                                <div className="col-md-3">
                                  ...
                                  <label>
                                    <input type="checkbox" min={0} __name__="extra_price[__number__][per_person]" defaultValue="on" />
                                    Price per person
                                  </label>
                                </div>
                                <div className="col-md-1">
                        ...
                        <div className="form-group app_get_locale">
                          <label><input type="checkbox" name="enable_service_fee" defaultChecked="checked" /> Enable service fee
                          </label>
                        </div>
                        <div className="form-group-item" data-condition="enable_service_fee:is(1)" style={{}}>
                              ...
                              <div className="row">
                                <div className="col-md-5">
                                  <div className="g-lang">
                                    ...
                                    <input type="text" name="service_fee[0][name]" style={{ border: "2px solid #DDE1EF" }} className="form-control" placeholder="Fee name" />
                                    <input type="text" name="service_fee[0][desc]" style={{ border: "2px solid #DDE1EF" }} className="form-control" placeholder="Fee desc" />
                                  </div>
                                </div>
                                <div className="col-md-3">
                                  <input type="number" min={0} step="0.1" name="service_fee[0][price]" className="form-control" />
                                  <select name="service_fee[0][unit]" className="form-control">
                                    <option value="fixed" selected="selected">Fixed</option>
                                    <option value="percent">Percent</option>
                                  </select>
                                </div>
                                <div className="col-md-3">
                                  <select name="service_fee[0][type]" className="form-control d-none">
                                    <option value="one_time" selected="selected">One-time
                                    </option>
                                  </select>
                                  <label>
                                    <input type="checkbox" min={0} name="service_fee[0][per_person]" defaultValue="on" />
                                    Price per person
                                  </label>
                                </div>
                                <div className="col-md-1">
                          ...
                          <div className="g-more hide">
                            <div className="item" data-number="__number__">
                              <div className="row">
                                ...
                                <div className="col-md-3">
                                  <select __name__="service_fee[__number__][type]" className="form-control d-none">
                                    <option value="one_time" selected="selected">One-time
                                    </option>
                                  </select>
                                  <label>
                                    <input type="checkbox" min={0} __name__="service_fee[__number__][per_person]" defaultValue="on" />
                                    Price per person
                                  </label>
                                </div>
                                <div className="col-md-1">
                    ...
                    <div className="panel">
                      ...
                      <div className="panel-body">
                        <div className="form-group">
                          ...
                          <div className>
                            <select name="location_id" className="form-control" value={location}
                        ...
                        <div className="form-group">
                          ...
                          <div className="control-map-group">
                            <div id="map_content" style={{ "position": "relative", "overflow": "hidden" }}>
                              <div style={{ "height": "100%", "width": "100%", "position": "absolute", "top": "0px", "left": "0px", "background-color": "rgb(229, 227, 223)" }}>
                                <div style={{ "position": "absolute", "z-index": "0", "left": "0px", "top": "0px", "height": "100%", "width": "100%", "padding": "0px", "border-width": "0px", "margin": "0px" }} className="gm-style">
                                  ...
                                  <div style={{ "position": "absolute", "z-index": "0", "left": "0px", "top": "0px", "height": "100%", "width": "100%", "padding": "0px", "border-width": "0px", "margin": "0px", "cursor": "url(\"openhand_8_8.cur.bmp\"), default", "touch-action": "pan-x pan-y" }} tabIndex={0} aria-label="Map" aria-roledescription="map" role="region" aria-describedby="C7A25D2B-7185-41B3-922D-E1D9C366DB24">
                                      ...
                                      <div style={{ "position": "absolute", "left": "0px", "top": "0px", "z-index": "0" }}>
                                        <div style={{ "position": "absolute", "z-index": "992", "-webkit-transform": "matrix(1, 0, 0, 1, -240, -33)", "-ms-transform": "matrix(1, 0, 0, 1, -240, -33)", "transform": "matrix(1, 0, 0, 1, -240, -33)" }}>
                                          <div style={{ "position": "absolute", "left": "0px", "top": "0px", "width": "256px", "height": "256px", "-webkit-transition": "opacity 200ms linear 0s", "transition": "opacity 200ms linear 0s" }}>
                                            <img style={{ "width": "256px", "height": "256px", "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none", "border": "0px", "padding": "0px", "margin": "0px", "max-width": "none" }} draggable="false" alt role="presentation" src={{ im1 }} />
                                          </div>
                                          <div style={{ "position": "absolute", "left": "256px", "top": "0px", "width": "256px", "height": "256px", "-webkit-transition": "opacity 200ms linear 0s", "transition": "opacity 200ms linear 0s" }}>
                                            <img style={{ "width": "256px", "height": "256px", "-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none", "border": "0px", "padding": "0px", "margin": "0px", "max-width": "none" }} draggable="false" alt role="presentation" src={{ im2 }} />
                                          </div>
                                    ...
                                    <div style={{ "z-index": "3", "position": "absolute", "height": "100%", "width": "100%", "padding": "0px", "border-width": "0px", "margin": "0px", "left": "0px", "top": "0px", "touch-action": "pan-x pan-y" }}>
                                      <div style={{ "z-index": "4", "position": "absolute", "left": "50%", "top": "50%", "width": "100%", "will-change": "transform", "-webkit-transform": "translate(0px)", "-ms-transform": "translate(0px)", "transform": "translate(0px)" }}>
                                        ...
                                        <div style={{ "position": "absolute", "left": "0px", "top": "0px", "z-index": "106", "width": "100%" }}>
                                          <span id="6ED0F60C-F804-4AF5-93B4-06FDE2FB290B" style={{ "display": "none" }}>To navigate,
                                    ...
                                    <div className="LGLeeN-keyboard-shortcuts-view" id="C7A25D2B-7185-41B3-922D-E1D9C366DB24" style={{ "display": "none" }}>
                                      <table>
                                        <tbody>
                                          <tr>
                                  ...
                                  <div>
                                    <div style={{ "display": "inline-flex", "position": "absolute", "right": "0px", "bottom": "0px" }}>
                                      ...
                                      <div className="gmnoscreen">
                                        ...
                                        </div><span id="DBE58A13-E10B-44D8-83A4-50F4A356C6EC" style={{ "display": "none" }}>Click to toggle
                            ...
                            <input style={{ width: "450px" }} type="text" placeholder="Search by name..." className="bravo_searchbox form-control pac-target-input" autoComplete="off" />
                            <div className="g-control">
                              ...
                              <div className="form-group">
                                ...
                                <input type="text" name="map_zoom" className="form-control" />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="panel">
                      <div className="panel-title"><strong>Surroundings</strong></div>
                      <div className="panel-body">
                        <div className="form-group-item">
                          ...
                          <div className="g-items">
                            <div className="item" data-number={0}>
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" style={{ border: "2px solid #DDE1EF" }} name="surrounding[1][0][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea name="surrounding[1][0][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input type="number" style={{ border: "2px solid #DDE1EF" }} name="surrounding[1][0][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select name="surrounding[1][0][type]" className="form-control">
                          ...
                          <div className="g-more hide">
                            <div className="item" data-number="__number__">
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" __name__="surrounding[1][__number__][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea __name__="surrounding[1][__number__][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input type="number" __name__="surrounding[1][__number__][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select __name__="surrounding[1][__number__][type]" className="form-control">
                                    <option value="m" selected="selected">m</option>
                                    <option value="km">km</option>
                                  </select>
                                </div>
                        ...
                        <div className="form-group-item">
                          ...
                          <div className="g-items">
                            <div className="item" data-number={0}>
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" style={{ border: "2px solid #DDE1EF" }} name="surrounding[2][0][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea name="surrounding[2][0][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input style={{ border: "2px solid #DDE1EF" }} type="number" name="surrounding[2][0][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select name="surrounding[2][0][type]" className="form-control">
                                    <option value="m" selected="selected">m</option>
                                    <option value="km">km</option>
                                  </select>
                                </div>
                          ...
                          <div className="g-more hide">
                            <div className="item" data-number="__number__">
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" __name__="surrounding[2][__number__][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea __name__="surrounding[2][__number__][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input type="number" __name__="surrounding[2][__number__][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select __name__="surrounding[2][__number__][type]" className="form-control">
                                    <option value="m" selected="selected">m</option>
                                    <option value="km">km</option>
                                  </select>
                                </div>
                        ...
                        <div className="form-group-item">
                          ...
                          <div className="g-items">
                            <div className="item" data-number={0}>
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" style={{ border: "2px solid #DDE1EF" }} name="surrounding[3][0][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea name="surrounding[3][0][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input style={{ border: "2px solid #DDE1EF" }} type="number" name="surrounding[3][0][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select name="surrounding[3][0][type]" className="form-control">
                                    <option value="m" selected="selected">m</option>
                                    <option value="km">km</option>
                                  </select>
                                </div>
                          ...
                          <div className="g-more hide">
                            <div className="item" data-number="__number__">
                              <div className="row">
                                <div className="col-md-3">
                                  <input type="text" __name__="surrounding[3][__number__][name]" className="form-control" placeholder="Sunny Beach" />
                                </div>
                                <div className="col-md-3">
                                  <textarea __name__="surrounding[3][__number__][content]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-3">
                                  <input type="number" __name__="surrounding[3][__number__][value]" className="form-control" placeholder />
                                </div>
                                <div className="col-md-2">
                                  <select __name__="surrounding[3][__number__][type]" className="form-control">
                                    <option value="m" selected="selected">m</option>
                                    <option value="km">km</option>
                                  </select>
                                </div>
                  ...
                  <div className="col-md-3">
                    <div className="panel">
                      ...
                      <div className="panel-body">
                        ...
                        <div className="text-right">
                          <button className="btn btn-primary" style={{ backgroundColor: "#051036" }} type="submit"><i className="fa fa-save" />
                            <span style={{ margin: "5px" }}>Save Changes</span></button>
                        </div>
                      </div>
                    </div>
                    <div className="panel">
                    ...
                    <div className="panel">
                      ...
                      <div className="panel-body">
                        <div className="form-group">
                          <label>Hotel Featured</label>
                          <br />
                          <label>
                            <input type="checkbox" name="is_featured" /> Enable featured
                          </label>
                        </div>
                      </div>
                    </div>
                    <div className="panel">
                      <div className="panel-title"><strong>Attribute: Property type</strong></div>
                      <div className="panel-body">
                        <div className="terms-scrollable">
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Apartments</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Hotels</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Homestays</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Villas</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Boats</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Motels</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Resorts</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Lodges</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Holiday homes</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Cruises</span>
                          </label>
                        </div>
                      </div>
                    </div>
                    <div className="panel">
                      <div className="panel-title"><strong>Attribute: Facilities</strong></div>
                      <div className="panel-body">
                        <div className="terms-scrollable">
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Wake-up call</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Car hire</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Bicycle hire</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Flat Tv</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Laundry and dry cleaning</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Internet – Wifi</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Coffee and tea</span>
                          </label>
                        </div>
                      </div>
                    </div>
                    <div className="panel">
                      <div className="panel-title"><strong>Attribute: Hotel Service</strong></div>
                      <div className="panel-body">
                        <div className="terms-scrollable">
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Havana Lobby bar</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Fiesta Restaurant</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Hotel transport services</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Free luggage deposit</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Laundry Services</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Pets welcome</span>
                          </label>
                          <label className="term-item">
                            <input type="checkbox" name="terms[]" />
                            <span className="term-name">Tickets</span>
                          </label>
                        </div>
                      </div>
                    </div>
            ...
            <div className="text-right" style={{marginRight: "280px"}}>
              <button className="btn btn-primary" style={{ backgroundColor: "#051036", }} type="submit">
                <span style={{ margin: "5px" }} >Submit</span></button>
            </div>
          </form>
        </div>
